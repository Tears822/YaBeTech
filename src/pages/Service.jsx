...
export default function Service() {
  const { t } = useLanguage()
  const { services, servicesPage, company } = t
  const serviceSelectOptions = servicesPage.serviceOptions.map((option) => ({
    value: option,
    label: option,
  }))
  const panelIntro = servicesPage.panelIntro
    .replace('{founder}', company.founder)
    .replace('{rate}', company.hourlyRate)

  return (
    <>
      <PageBreadcrumb title={t.pages.services} />
            ...
            <div className="row g-4 align-items-center">
              <div className="col-lg-6">
                <SectionHeading
                  ...
                  title={servicesPage.panelTitle}
                  titleAccent={servicesPage.panelTitleAccent}
                  intro={panelIntro}
                  align="left"
                  light
                />
              ...
              <div className="col-lg-6">
                <div className="contact-box-items style-2">
                  <SectionHeading
                    eyebrow={servicesPage.panelEyebrow}
                  ...
                  >
                    <div className="row g-4 align-items-center">
                      ...
                      <div className="col-lg-6 col-md-6 wow fadeInUp" data-wow-delay=".3s">
                        <div className="form-clt">
                          <input type="tel" placeholder={t.forms.phoneRequired} />
                        </div>
                      </div>
                      <div className="col-lg-6 col-md-6 wow fadeInUp" data-wow-delay=".5s">
                        <div className="form-clt">
                          <div className="form">
                            <FormSelect
                              name="service"
                              placeholder={t.forms.serviceChoose}
                      ...
                      <div className="col-lg-12 wow fadeInUp" data-wow-delay=".3s">
                        <div className="form-clt">
                          <textarea name="message" placeholder={t.forms.messageShort} />
                        </div>
                      </div>
                      <div className="col-lg-12 wow fadeInUp" data-wow-delay=".5s">
                        <ThemeButton to="/contact">{t.common.contactMe}</ThemeButton>
                      </div>
                    </div>
                  </form>
                </div>
