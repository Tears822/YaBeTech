          ...
          <div className="row g-4 align-items-center">
            <div className="col-lg-6">
              <div className="hero-content">
                ...
                <ThemeButton to={hero.ctaLink} wowDelay=".5s">
                  {hero.ctaText}
                </ThemeButton>
                <div className="hero-info wow fadeInUp" data-wow-delay=".7s">
                  <div className="info-content">
                    <h3>
                      <span className="count">{hero.statValue}</span>
                      {hero.statSuffix}
                    </h3>
                    <p>{hero.statLabel}</p>
                  </div>
      ...
      <section className="feature-section section-padding fix">
        <div className="container">
          <div className="section-title-area">
            <SectionHeading
              eyebrow="WHAT WE DO"
              title="Real solutions for"
              titleAccent="real business problems."
              align="left"
              className="mb-0"
            />
