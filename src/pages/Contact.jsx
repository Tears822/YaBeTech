...
export default function Contact() {
  const { t } = useLanguage()
  const { contactPage, servicesPage, company } = t
  ...
  const firstName = company.founder.split(' ')[0]

  return (
    <>
      <PageBreadcrumb title={t.pages.contact} />
                ...
                <div className="content">
                  ...
                  <div className="contact-info-lines">
                    ...
                    <a
                      ...
                      rel="noreferrer"
                    >
                      {t.common.linkedIn}: {company.founder}
                    </a>
                  </div>
                </div>
              </div>
              ...
              <div className="contact-info-box">
                ...
                <div className="content">
                  ...
                  <div className="contact-info-lines">
                    ...
                    <span className="contact-info-lines__item">
                      {t.common.contractRate}: {company.hourlyRate}
                    </span>
                  </div>
                </div>
              </div>
                ...
                <div className="contact-box-items">
                  ...
                  >
                    <div className="row g-4 align-items-center">
                      ...
                      <div className="col-lg-6 col-md-6 wow fadeInUp" data-wow-delay=".3s">
                        <div className="form-clt">
                          <input type="tel" placeholder={t.forms.phone} />
                        </div>
                      </div>
                      <div className="col-lg-6 col-md-6 wow fadeInUp" data-wow-delay=".5s">
                        <div className="form-clt">
                      ...
                      <div className="col-lg-12 wow fadeInUp" data-wow-delay=".3s">
                        <div className="form-clt">
                          <textarea name="message" placeholder={t.forms.message} />
                        </div>
                      </div>
                      <div className="col-lg-12 wow fadeInUp" data-wow-delay=".5s">
                        <ThemeButton type="submit">{t.common.sendMessage}</ThemeButton>
                      </div>
                    </div>
                  </form>
                </div>
      ...
      <CtaBanner
        ...
        buttonText={t.common.emailName.replace('{name}', firstName)}
